...
@section('title', 'App Bar: Top - Dense')
...
<x-MaterialBlade::AppBar variant="dense">
    <x-slot name="start">
    ...
    <x-slot name="end">
        <x-MaterialBlade::IconButton icon="favorite" color="inherit" aria-label="Favorite" />
        <x-MaterialBlade::IconButton icon="search" color="inherit" aria-label="Search" />
        <x-MaterialBlade::IconButton icon="more_vert" color="inherit" aria-label="Options" />
    </x-slot>
