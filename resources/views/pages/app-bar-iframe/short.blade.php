...
@section('title', 'App Bar: Top - Short')
...
<x-MaterialBlade::AppBar variant="short">
    <x-slot name="start">
    ...
    <x-slot name="end">
        <x-MaterialBlade::IconButton icon="bookmark" color="inherit" aria-label="Bookmark this page" />
    </x-slot>
